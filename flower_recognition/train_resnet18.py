...
from model.model_resnet18 import ResNet18  # 导入 ResNet18 模型
...
def main(args):
    ...
    dataset_config = {
        ...
        'CIFAR10': {
            'Dataset': MyDataSet,
            'train_data_path': "../CIFAR10/CIFAR-10-dataset-main/train",
            'test_data_path': "../CIFAR10/CIFAR-10-dataset-main/test",
            'in_c': "3"
        },
        'MINIST': {
            'Dataset': MyDataSet,
            'train_data_path': "../MINIST/minist/train",
            'test_data_path': "../MINIST/minist/test",
            'in_c': "3"
        },
    }
    ...
    output_dir = f"./ResNet18/weights_{args.dataset}"
    ...
    # 创建 ResNet18 模型实例
    actual_num_classes = dataset_config[args.dataset]['num_classes']
    model = ResNet18(num_classes=actual_num_classes).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=100)  # 增加训练轮次
    ...
    parser.add_argument('--dataset', type=str, default='flower', help='CIFAR10')
